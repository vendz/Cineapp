...
public class SeriesCastsAdapter extends RecyclerView.Adapter<SeriesCastsAdapter.CastViewHolder> {
    ...
    @NonNull
    @Override
    public SeriesCastsAdapter.CastViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CastViewHolder(LayoutInflater.from(mContext).inflate(R.layout.cast_single_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull SeriesCastsAdapter.CastViewHolder holder, int position) {
